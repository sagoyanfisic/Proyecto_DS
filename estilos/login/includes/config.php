...
****************/
mysql_connect('localhost', 'root', 'root') or trigger_error("Unable to connect to the database: " . mysql_error());
mysql_select_db('mibase') or trigger_error("Unable to switch to the database: " . mysql_error());
...
require_once($_SERVER['mibase'] . $sFolder . '/includes/functions.php');
